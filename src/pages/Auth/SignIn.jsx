          ...
          <form className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <Checkbox id="remember" checked={rememberMe} onCheckedChange={setRememberMe} primaryColor="emerald" />
            ...
            <CustomButton type="submit" className="w-full" size="lg" primaryColor="emerald">
              Sign In
            </CustomButton>
            ...
            <div className="text-center">
              <span className="text-gray-600">
                ...
                <Link to="/sign-up" className="font-medium text-emerald-600 hover:text-emerald-700 underline">
                  Sign Up
                </Link>
              </span>
            </div>
